...
public final class BasicTokenizer {
    ...
    static String cleanText(String text) {
        ...
        for (int index = 0; index < text.length(); index++) {
            ...
            if (javac.javaTokenization.CharChecker.isInvalid(ch) || javac.javaTokenization.CharChecker.isControl(ch)) {
                continue;
            }
            if (javac.javaTokenization.CharChecker.isWhitespace(ch)) {
    ...
    static List<String> runSplitOnPunc(String text) {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            if (javac.javaTokenization.CharChecker.isPunctuation(ch)) {
